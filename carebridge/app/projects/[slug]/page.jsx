...
const projectData = {
  "clean-water": {
    ...
    fullDescription: `
      <strong>Providing Access to Safe and Sustainable Drinking Water</strong><br/><br/>
  ...
  "education": {
    ...
    fullDescription: `
      <strong>Empowering the Next Generation of Women Leaders</strong><br/><br/>
  ...
  "food": {
    ...
    fullDescription: `
      <strong>Ensuring Nutrition and Hygiene for Vulnerable Families</strong><br/><br/>
  ...
  "hygiene": {
    ...
    fullDescription: `
      <strong>Preventing Disease and Promoting Health Through Hygiene Education</strong><br/><br/>
...
export default function ProjectPage({ params }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar /> 
      <main className="flex-grow max-w-4xl mx-auto p-14">
